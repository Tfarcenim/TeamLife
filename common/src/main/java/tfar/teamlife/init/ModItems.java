...
public class ModItems {
    ...
    public static final Item PERSONAL_BEACON = new PersonalBeaconItem(new Item.Properties().stacksTo(1));
    public static final Item TEAM_INVENTORY_POUCH = new TeamInventoryItem(new Item.Properties().stacksTo(1));
    ...
    public static final Item TEAM_REGENERATION = new EnchantmentTomeItem(new Item.Properties().stacksTo(1));
    public static final Item INFINITE_FIREWORK_ROCKET = new InfiniteFireworkRocketItem(new Item.Properties().stacksTo(1));

    public static final Item INFINITE_FIREWORK_ROCKET_ARTIFACT = new InfiniteFireworkRocketItem(new Item.Properties().stacksTo(1));
    public static final Item TEAM_REGENERATION_ARTIFACT = ArtifactItem.enchantedTome(new Item.Properties().stacksTo(1));
    public static final Item PERSONAL_BEACON_ARTIFACT = new PersonalBeaconItem(new Item.Properties().stacksTo(1));
    public static final Item TEAM_INVENTORY_POUCH_ARTIFACT = new TeamInventoryItem(new Item.Properties().stacksTo(1));
    ...
    public static final Item CHESTPLATE_WITH_ELYTRA_ARTIFACT = new ArtifactItem(new Item.Properties().stacksTo(1),() -> Set.of(LEATHER_CHESTPLATE_WITH_ELYTRA,GOLDEN_CHESTPLATE_WITH_ELYTRA,CHAINMAIL_CHESTPLATE_WITH_ELYTRA,IRON_CHESTPLATE_WITH_ELYTRA,DIAMOND_CHESTPLATE_WITH_ELYTRA,NETHERITE_CHESTPLATE_WITH_ELYTRA));
